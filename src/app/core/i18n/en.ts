export const ENGLISH_RESOURCES: Record<string, string> = {
  ...
  Disabled: 'Disabled',
  Exclude: 'Exclude',
  'Exclude Swedish public holidays': 'Exclude Swedish public holidays',
  'Fixed amount': 'Fixed amount',
  Hourly: 'Hourly',
  Include: 'Include',
  Manual: 'Manual',
  Monthly: 'Monthly',
  'Monthly divisor': 'Monthly divisor',
  ...
  'Backup created: {0}': 'Backup created: {0}',
  'Could not create a backup: {0}': 'Could not create a backup: {0}',
  'Could not export the report: {0}': 'Could not export the report: {0}',
  'Could not open the data folder: {0}': 'Could not open the data folder: {0}',
  'Could not open the file dialog: {0}': 'Could not open the file dialog: {0}',
  'Could not reload the database: {0}': 'Could not reload the database: {0}',
  'Could not restore or import the database: {0}':
    'Could not restore or import the database: {0}',
  'Database restored.': 'Database restored.',
  'Excel Workbook': 'Excel Workbook',
  'Export Timesheet Report': 'Export Timesheet Report',
  'Imported {0} entries from Tidverk.': 'Imported {0} entries from Tidverk.',
  'OpenDocument Spreadsheet': 'OpenDocument Spreadsheet',
  'Report exported: {0}': 'Report exported: {0}',
  'Select a Dagsverk backup': 'Select a Dagsverk backup',
  'Select a Tidverk database': 'Select a Tidverk database',
  'SQLite database': 'SQLite database',
  'A rule end time is invalid.': 'A rule end time is invalid.',
  'A rule start time is invalid.': 'A rule start time is invalid.',
  'Default end time is invalid.': 'Default end time is invalid.',
  'Default start time is invalid.': 'Default start time is invalid.',
  'Employment percent must be from 1 to 100.': 'Employment percent must be from 1 to 100.',
  'Enter a rule name.': 'Enter a rule name.',
  'Enter a valid non-negative number.': 'Enter a valid non-negative number.',
  'Enter a valid non-negative whole number.': 'Enter a valid non-negative whole number.',
  'Enter a valid time.': 'Enter a valid time.',
  'Enter a valid whole number.': 'Enter a valid whole number.',
  'Interface scale is invalid.': 'Interface scale is invalid.',
  'Overtime rule fields are out of sync.': 'Overtime rule fields are out of sync.',
