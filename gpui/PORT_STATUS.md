...
| Timesheet views | `src/app/features/month-workspace/` | `dagsverk-ui/views/timesheet` | Yes | In progress | Wayland launch | In progress | Summary, full-month ledger, calendar grid, row and cell activation, and the first persisted day-editor slice are connected to real state. |
