...
| Material 3 foundation | `src/styles.scss` | `dagsverk-ui/m3` | Yes | In progress | Linux | In progress | Tokens, typography, buttons, cards, input, switches, chips, status chips, and Material Symbols compile and launch on Wayland. |
